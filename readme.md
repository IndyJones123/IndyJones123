...
- 🏢 **Co-Founder & Senior Software Engineer** at **PT REOG SOLO DEV**
- 🔭 Also currently working at **Mitrasoft Global Perdana** and handling high-impact **Commission Projects**
- 💼 I have **3+ years of experience** in web development, backend architecture, automation, and game development
- 🧠 Passionate about creating scalable systems, digital marketing automation, and smooth user experiences
- 💬 Ask me about **Python, TypeScript, FastAPI, Vue.js/React, Unity, or system design**
- 📫 Reach me at: **alfianitem999@gmail.com**
- 🌐 Portfolio: [reogsolodev.com](https://reogsolodev.com) / [GitHub Pages](https://indyjones123.github.io/deploy-porto/)
...
| Project | Description | Tech Stack | Status | Link |
|---------|-------------|------------|--------|------|
| [The Savior Rain Shaman](https://agasuck.itch.io/the-savior-rainshaman-kobokanaeru-hololive-fanmade) | 2D Platformer game — Kobo Kanaeru (Hololive) Fanmade | Unity, C# | 🟢 Active | [GitHub](https://github.com/IndyJones123/Game-KoboAdventure) |
